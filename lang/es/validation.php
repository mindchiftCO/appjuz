...
return [
    ...
    | defecto utilizados por la clase de validador. Algunas de estas reglas
    ...
    */
    ...
    | líneas. Esto nos permite especificar rápidamente una línea de
    | lenguaje personalizada específica para una regla de atributo dada.
    |
    */
    ...
    | nuestro marcador de posición de atributo por algo más amigable para
    | el lector, como "Dirección de correo electrónico" en lugar de "email".
