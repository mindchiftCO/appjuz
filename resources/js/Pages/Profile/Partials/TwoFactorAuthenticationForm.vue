        ...
        <template #content>
            ...
            <div class="mt-3 max-w-xl text-sm text-gray-600">
                <p>
                    ...
                    teléfono o desde el llavero de su iphone.
                </p>
            </div>
                ...
                <div v-if="qrCode">
                    <div class="mt-4 max-w-xl text-sm text-gray-600">
                        ...
                        <p v-else>
                            ...
                            usando la aplicación de autenticación de su teléfono o ingrese la clave de configuración.
                        </p>
                    </div>
                ...
                <div v-if="recoveryCodes.length > 0 && !confirming">
                    <div class="mt-4 max-w-xl text-sm text-gray-600">
                        <p class="font-semibold">
                            ...
                            utilizar para recuperar el acceso a su cuenta si pierde su dispositivo de autenticación de
                            dos factores.
                        </p>
                    </div>
